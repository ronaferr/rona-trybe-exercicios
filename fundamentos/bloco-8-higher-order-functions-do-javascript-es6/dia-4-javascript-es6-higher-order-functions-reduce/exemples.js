...
const sumOdd = (acumulador, number) => ((number % 2 === 0) ? acumulador + number : acumulador + 0);

const result = numbers.reduce(sumOdd, 0);
console.log(result); */

/* const odds = numbers.filter((number) => number % 2 === 0);
console.log(odds);
const result2 = odds.reduce((acumulador, number) => acumulador + number);
console.log(result2); */
