const estudantes = [
  ...
  function mensagem(array) {
      let name = array.find(student => student.status < 80).nome;
      return `Olá ${name}, o prazo para entrega do projeto é daqui a 3 dias, vc precisa de alguma ajuda?`
  }
  console.log(mensagem(estudantes));
  ...
  // escreva sua função aqui.
  function mensagemHelp(array) {
    let name = array.find(student => student.status === 100).nome;
    return `Olá ${name}, parabéns por ter finalizado 100% do projeto, o que vc acha de ajudar outras pessoas da turma a tbm entregarem o projeto?`
}
console.log(mensagemHelp(estudantes));
